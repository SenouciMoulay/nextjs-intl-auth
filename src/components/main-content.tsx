...
export default function MainContent() {
  ...
  return (
    ...
    >
      ...
      <motion.div className="flex flex-col gap-4 pt-28" variants={fadeIn}>
        <h1 className="text-xl font-medium text-muted-foreground">Info</h1>
      ...
      <motion.div className="flex flex-col gap-4 pt-10" variants={fadeIn}>
        <h1 className="text-xl font-medium text-muted-foreground">Selected Experiences</h1>
        <div>
          <ExperiencesList />
        </div>
      </motion.div>
